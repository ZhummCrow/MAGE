...
# 01Downloading and preprocessing BRENDA data.ipynb: step2
# Used to get SMILES
def get_comp(comp):
    try:
...
# 01Downloading and preprocessing BRENDA data.ipynb: step3
...
# 02Downloading and preprocessing Sabio-RK data.ipynb: step1 (a)
# Used to handle multiple kcat entries with km entries.
...
# 02Downloading and preprocessing Sabio-RK data.ipynb: step1 (b)
# Used to obtain molecular mass and unit conversion of km
def get_mol_weight(comp):
    try:
        compound = pcp.get_compounds(comp, 'name')
    except:
