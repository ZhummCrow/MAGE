...
# command
python reproduce.py --task kcat --level random --test_dataset_path "$TEST_DATASET_PATH"kcat_random_test.csv --pdbs_path "$TEST_PDBS_PATH" --artifacts_path "$ARTIFACTS_PATH" --feature_path "$FEATURE_PATH"
...
python reproduce.py --task km --level random --test_dataset_path "$TEST_DATASET_PATH"km_random_test.csv --pdbs_path "$TEST_PDBS_PATH" --artifacts_path "$ARTIFACTS_PATH" --feature_path "$FEATURE_PATH"
